...
public interface MultiChatService {
	...
	void enterToChatRoom(String id, String memberNickName, String roomName, String roomNumber) throws SQLException;// 채팅방
																													// 입장
	...
	List<String> getRoomMemberList(int roomNumber) throws SQLException;
